...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, DLPS_Pin|LED_G_Pin|LED_R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DLPS_Pin LED_G_Pin LED_R_Pin */
  GPIO_InitStruct.Pin = DLPS_Pin|LED_G_Pin|LED_R_Pin;
