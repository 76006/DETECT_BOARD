...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, PEAK_Pin|DLPS_Pin|LED_G_Pin|LED_R_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOE, DLPS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CONV_GPIO_Port, CONV_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PEAK_Pin DLPS_Pin RGB1_Pin RGB2_Pin
                           LED_G_Pin LED_R_Pin */
  GPIO_InitStruct.Pin = PEAK_Pin|DLPS_Pin|LED_G_Pin|LED_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : CONV_Pin */
